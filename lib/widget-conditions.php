 ...
 * @example
 *
 *        add_action( 'init', array( 'UsabilityDynamics\WidgetConditions\Bootstrap', 'init' ) );
 *
 *
 */
namespace UsabilityDynamics\WidgetConditions {
  ...
  class Bootstrap {
     ...
     */
    public static function options_echo( $major = '', $minor = '' ) {
      switch( $major ) {
        case 'category':
          ?>
    ...
    public static function options() {
      self::options_echo( $_REQUEST[ 'major' ], isset( $_REQUEST[ 'minor' ] ) ? $_REQUEST[ 'minor' ] : '' );
      die;
    }
          ...
          foreach( $conditions[ 'rules' ] as $rule ) {
            ...
            <div class="condition">
                ...
                <select class="conditions-rule-minor" name="conditions[rules_minor][]" <?php if( !$rule[ 'major' ] ) { ?> disabled="disabled"<?php } ?> data-loading-text="<?php esc_attr_e( 'Loading...', 'jetpack' ); ?>">
									<?php self::options_echo( $rule[ 'major' ], $rule[ 'minor' ] ); ?>
								</select>
